...
input ulong InpMagicNumber = 10011; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Pin Bar Reversal BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Pin Bar Reversal SELL");
     }
  }
//+------------------------------------------------------------------+
