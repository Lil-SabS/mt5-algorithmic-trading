...
input ulong InpMagicNumber = 10015; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Donchian Channel Breakout BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Donchian Channel Breakout SELL");
     }
  }
//+------------------------------------------------------------------+
