...
input ulong InpMagicNumber = 10008; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Parabolic SAR Trend Follower BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Parabolic SAR Trend Follower SELL");
     }
  }
//+------------------------------------------------------------------+
