...
input ulong InpMagicNumber = 10013; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Heiken Ashi Smoothed BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Heiken Ashi Smoothed SELL");
     }
  }
//+------------------------------------------------------------------+
