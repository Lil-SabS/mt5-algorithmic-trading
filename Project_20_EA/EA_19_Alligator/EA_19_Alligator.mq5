...
input ulong InpMagicNumber = 10019; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Alligator Trend Follower BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Alligator Trend Follower SELL");
     }
  }
//+------------------------------------------------------------------+
