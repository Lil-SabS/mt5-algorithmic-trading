...
input ulong InpMagicNumber = 10010; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Inside Bar Breakout BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Inside Bar Breakout SELL");
     }
  }
//+------------------------------------------------------------------+
