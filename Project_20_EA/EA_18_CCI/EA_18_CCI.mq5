...
input ulong InpMagicNumber = 10018; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "CCI Oversold/Overbought BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "CCI Oversold/Overbought SELL");
     }
  }
//+------------------------------------------------------------------+
