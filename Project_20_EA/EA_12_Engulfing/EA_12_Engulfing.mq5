...
input ulong InpMagicNumber = 10012; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Engulfing Candlestick BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Engulfing Candlestick SELL");
     }
  }
//+------------------------------------------------------------------+
