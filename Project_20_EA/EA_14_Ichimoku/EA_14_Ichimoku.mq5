...
input ulong InpMagicNumber = 10014; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Ichimoku Kinko Hyo BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Ichimoku Kinko Hyo SELL");
     }
  }
//+------------------------------------------------------------------+
