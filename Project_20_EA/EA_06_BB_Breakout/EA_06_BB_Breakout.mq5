...
input ulong InpMagicNumber = 10006; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Bollinger Bands Breakout BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Bollinger Bands Breakout SELL");
     }
  }
//+------------------------------------------------------------------+
