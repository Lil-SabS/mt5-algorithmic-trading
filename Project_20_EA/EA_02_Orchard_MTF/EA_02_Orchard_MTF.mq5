...
input ulong InpMagicNumber = 10002; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Multi-Timeframe Scalper BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Multi-Timeframe Scalper SELL");
     }
  }
//+------------------------------------------------------------------+
