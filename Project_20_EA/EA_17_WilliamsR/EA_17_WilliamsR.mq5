...
input ulong InpMagicNumber = 10017; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Williams %R Oscillator BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Williams %R Oscillator SELL");
     }
  }
//+------------------------------------------------------------------+
