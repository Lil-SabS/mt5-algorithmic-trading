...
input ulong InpMagicNumber = 10009; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "ATR Breakout & Trailing BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "ATR Breakout & Trailing SELL");
     }
  }
//+------------------------------------------------------------------+
