...
input ulong InpMagicNumber = 10001; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "SMA Trend BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "SMA Trend SELL");
     }
  }
//+------------------------------------------------------------------+
