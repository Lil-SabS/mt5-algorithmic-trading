...
input ulong InpMagicNumber = 10004; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "MACD Zero Cross BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "MACD Zero Cross SELL");
     }
  }
//+------------------------------------------------------------------+
