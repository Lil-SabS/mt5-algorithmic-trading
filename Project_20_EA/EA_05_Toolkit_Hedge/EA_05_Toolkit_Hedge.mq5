...
input ulong InpMagicNumber = 10005; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Hedging / Recovery BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Hedging / Recovery SELL");
     }
  }
//+------------------------------------------------------------------+
