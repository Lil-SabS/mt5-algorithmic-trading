...
input ulong InpMagicNumber = 10016; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Envelope Mean Reversion BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Envelope Mean Reversion SELL");
     }
  }
//+------------------------------------------------------------------+
