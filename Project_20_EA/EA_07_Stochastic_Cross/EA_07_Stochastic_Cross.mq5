...
input ulong InpMagicNumber = 10007; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Stochastic Crossover BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Stochastic Crossover SELL");
     }
  }
//+------------------------------------------------------------------+
