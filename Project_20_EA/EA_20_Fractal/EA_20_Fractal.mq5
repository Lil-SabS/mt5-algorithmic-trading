...
input ulong InpMagicNumber = 10020; // Magic Number
   ...
   if(buy_condition)
     {
      ...
      trade.Buy(InpLotSize, _Symbol, Ask, sl, tp, "Fractal Breakout BUY");
     }
   else if(sell_condition)
     {
      ...
      trade.Sell(InpLotSize, _Symbol, Bid, sl, tp, "Fractal Breakout SELL");
     }
  }
//+------------------------------------------------------------------+
